                ...
                <Dropdown.Menu className="navbar-dropdown preview-list create-new-dropdown-menu">
                  ...
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1"><Trans>In Progress................</Trans></p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
            ...
            <Dropdown alignRight as="li" className="nav-item border-left" >
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list">
                  ...
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
                        <img src={require('../../assets/images/openmrs.png')} alt="profile" className="rounded-circle profile-pic" />
                      </div>
                    </div>
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1"><Trans>Message 1</Trans></p>
                      <p className="text-muted mb-0"> 1 <Trans>second ago</Trans> </p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1"><Trans>Message 2</Trans></p>
                      <p className="text-muted mb-0">  <Trans>Minutes ago</Trans> </p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
              ...
              <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list">
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    ...
                    <Trans>Achieve All Deliverables</Trans>
                    </p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <h6 className="preview-subject mb-1"><Trans>Contact Health Informatics</Trans></h6>
                    <p className="text-muted ellipsis mb-0">
                    <Trans>Reach Out Now</Trans>!
                    </p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
            ...
            <Dropdown alignRight as="li" className="nav-item">
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  ...
                  <p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>OpenMRS</Trans></p>
